...
<div class="tab-pane fade show active" id="insc1-tab-pane" role="tabpanel" aria-labelledby="insc1-tab" tabindex="0">
    ...
    <form class="needs-validation" novalidate>
        ...
        <button type="submit" class="btn btn-primary mb-3" onclick="validateForm(event)">Suivant</button>
    </form>
</div>
<script>
    function validateForm(event) {
        ...
        // Passe à la page suivante si tous les champs requis sont remplis
