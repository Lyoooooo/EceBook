...
if (isset($_POST["bouton"])) {
    ...
    if ($ligne) {
        session_start();
        $_SESSION["idu"] = $ligne["idu"];                           //recuperation des données de l'utilisateur 
...
<body style="background-color: white;">
    <?php if (isset($erreur)) : ?> <!--affichage d'un message d'erreur si jamais le mail ou le mot de passe n'est pas bon-->
        ...
        <script>
            setTimeout(function() { // affiche l'alerte seulement 4 secondes
    ...
    <div class="row g-3 position-absolute top-50 start-50 translate-middle rounded shadow text-center" id="primal">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation"> <!--créattion d'une nav-tab dans laquel nous allons rentré notre mail et notre mot de passe pour nous connecter -->
        ...
        <div class="tab-pane fade show active" id="insc1-tab-pane" role="tabpanel" aria-labelledby="insc1-tab" tabindex="0">
            ...
            <div class="container">
                <form action="" method="post">
                    <label for="validationDefault01" class="form-label">Entrez votre adresse mail</label> <span class="etoile">*</span><br> <!--formulaire pour rentrer son adresse mail-->
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Entrez votre mot de passe</label><span class="etoile">*</span> <!--formulaire pour rentrer son mot de passe-->
                        <div class="input-group">
                            <span class="input-group-text" id="inputGroupPrepend2"> <svg fill="none" viewBox="0 0 24 24" height="20" width="15" xmlns="http://www.w3.org/2000/svg" class="icon"> <!--icone de cadena-->
                    ...
                    <input type="reset" class="btn btn-primary" value="ANNULER">&nbsp;&nbsp;&nbsp;&nbsp; <!--reset le formulaire-->
                    <input type="submit" class="btn btn-primary" value="ENVOYER" name="bouton"> <br> <!--valide le formulaire et redirige vers index.php-->
                </form>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" style="color: #ff621f;" href="inscription.php">Pas de compte? Inscrivez vous</a> <!-- lien vers le formulaire de connexion-->
                <a class="dropdown-item" style="color: #ff621f;" href="#">Mot de passe oublié?</a>  <!-- lien vers le formulaire de reinitialisationde mot de passe-->
            </div>
        </div>
    </div>
    </div>
